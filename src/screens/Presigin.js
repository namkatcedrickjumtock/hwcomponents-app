...
const Presigin = () => {
    ...
    return (
        <>
            <Container className='d-flex mt-5 justify-content-center align-items-center presignin-container'>
                <h3 className='text-center  fs-4 py-4'>Join as a client or freelancer</h3>
                <Row>
                ...
                <div className="p-3 btn-container">
                    <Button disabled={ isButtonDisable } size="md" className='rounded-pill text-sm presignin-btn mb-4 mx-auto d-block'>{ userType }</Button>
